# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2023-08-12 16:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.BigIntegerField(null=True, verbose_name='用户手机号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_theme', models.CharField(max_length=256, verbose_name='站点样式')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
                ...
                ('blog', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Blog', verbose_name='多对一Blog表')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Comment', verbose_name='根评论子评论')),
        ...
        migrations.AddField(
            model_name='article',
            name='blog',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Blog', verbose_name='多对一Blog表'),
        ),
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Category', verbose_name='一对多Category表'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='blog',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Blog', verbose_name='一对一Blog表'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='groups',
